...
# chi2:6.544667820529891, pvalue:0.58645743
# 해석 : pvalue:0.586 > 0.05 보다 크므로 귀무 채택. 교육방법에 따른 교육생들의 만족도에 차이가 있다.
...
chi2, pvalue, _, _ = scipy.stats.chi2_contingency(ctab)
print('chi2:{}, pvalue:{}'.format(chi2, pvalue))
# chi2:102.75202494484225, pvalue:1.167906
# 해석 : pvalue:1.1679064204212775e-18 < 0.05 이므로 귀무기각.
# 위 수집 데이터는 표본 
