# 기술통계 분석
# 기술통계는 측정이나 실험에서 수집한 자료(data)의 정리, 요약, 해석, 표현 등을 통해 자료의 특성을 규명하는 통계적 방법
# 돗수분포표 : 특정 구간에 속하는 자료(변량 집합)의 수를 나타내는 표(빈도표)
import pandas as pd
