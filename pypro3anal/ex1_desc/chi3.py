# 이원 카이 제곱 검정 - 두 개 이상의 집단(범주형 변인)을 대상으로 독립성, 동질성 검정
...
# 귀무 : 교육수준과 흡연율 간의 관련이 있다. (독립이 아니다)

import pandas as pd 
import scipy.stats as stats 

data1 = pd.read_csv("../testdata/smoke.csv")  # 표본 자료
print(data1.head(3), data1.shape)   # 355행
...
# chi2:18.910915739853955, p:0.0008182572832162924, df:4
# 판정 : p:0.00081 < 0.05 이기 때문에 유의한 수준(α=0.05)에서 귀무가설을 기각한다. 
# 발생된 데이터는 우연히 발생된 자료가 아니다. 
# 교육 수준과 흡연율 간에 관련이 있다. 
