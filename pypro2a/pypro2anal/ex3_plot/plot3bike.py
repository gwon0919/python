...
plt.style.use('ggplot')         # R 의 ggplot 스타일을 사용
...
# print(train.isnull().sum()) # null  여부 
# print(train.isna().sum())     # isNA 여부

# 참고 :  null이 포함된 칼람 확인용 시각화 라이브러리 pip install missingno를 사용한다.
...
axes[1][0].set(xlabel='hour', ylabel='Count', title='시간대별 대여량')
