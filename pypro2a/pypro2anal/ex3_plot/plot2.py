# matplotlib style interface / 객체 지향 interface, 차트 종류 몇 가지 경험하기
import numpy as np
...
print(set(iris_data['Species']))            # {'setosa', 'virginica', 'versicolor'}
...
sns.pairplot(iris_data, hue='Species', height=2)        # hue : category
